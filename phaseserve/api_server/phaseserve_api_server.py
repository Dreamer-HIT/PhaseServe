...
python -m phaseserve.api_server.phaseserve_api_server \\
    --host 0.0.0.0 \\
    --port {port} \\
    --model {args.model} \\
...
import phaseserve
import phaseserve.engine
from phaseserve.llm import AsyncLLM
from phaseserve.request import SamplingParams
from phaseserve.utils import random_uuid, set_random_seed
from phaseserve.logger import init_logger
from phaseserve.single_stage_engine import StepOutput
...
from phaseserve.lifetime import json_encode_lifetime_events
...
if __name__ == "__main__":
    ...
    phaseserve.engine.add_engine_cli_args(parser)
